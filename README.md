...
Request Parameters Support module provides functionality of models or enums 
injection into REST requests parameters.
...
Dynamic Solutions WebSight (Request Parameters Support) - Request Parameters Support
